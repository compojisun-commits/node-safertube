  ...
  return (
    <footer className="app-footer-container">
      <div className="footer-links">
        ...
        <span className="footer-divider">|</span>
        <button onClick={handleAccountDeletion} className="footer-link footer-link-red">
          탈퇴요청
        </button>
      </div>

      <div className="footer-info">
        <p><strong>튜브링</strong> - 교실에서 안전하게 YouTube를 활용하세요</p>
        <p>AI 기반 YouTube 콘텐츠 안전 분석 서비스 (by. 쿠큐쌤, 말랑한거봉)</p>
