              ...
              <div className="collapsible-section">
                ...
                >
                  <div className="collapsible-title">
                    ...
                    <span className="text-lg font-semibold">카테고리별 안전 등급</span>
                  </div>
                  <svg 
              ...
              <div className="collapsible-section comprehension">
                ...
                >
                  <div className="collapsible-title">
                    ...
                    <span className="text-lg font-semibold">이해도 분석</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {analysis.flow.map((segment, idx) => (
                <div
                  ...
                  className="flow-item p-3 bg-gray-50 border-l-4 border-green-500 rounded hover:bg-green-50 transition-colors cursor-pointer"
                >
                  <div className="timestamp-btn text-green-600 hover:text-green-800 font-bold flex items-center gap-1">
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM9.555 7.168A1 1 0 008 8v4a1 1 0 001.555.832l3-2a1 1 0 000-1.664l-3-2z" clipRule="evenodd" />
                    </svg>
                    {segment.timestamp}
